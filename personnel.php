...
if (isset($_GET['delete_id'])) {
    ...
    $query = "DELETE FROM personnel WHERE code = :id";
...
if (isset($id)) {
    $query = "SELECT * FROM personnel WHERE code = :id";
    $stmt = $pdo->prepare($query);
    $stmt->execute(['id' => $id]);
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($person)) {
        // Add new drug
        $query = "INSERT INTO personnel (name, code, medal, personnel_code, city, birth, dispatch, phone, status, type)
                VALUES ('$name', '$code', '$medal', '$personnel_code', '$city', '$birth', '$dispatch', '$phone', '$status', '$type')";
...
if(isset($_GET['search'])){
  ...
  $query = "SELECT * FROM $table_name LIMIT 6 OFFSET $offset";
  $stmt = $pdo->prepare($query);
  $stmt->execute();
  $personnel = $stmt->fetchAll(PDO::FETCH_ASSOC);
}
  ...
  <body>
    <div class="container-fluid h-auto">
      <div class="row h-100">
              ...
              <?php if($_SESSION['personnel']) : ?>
                <a href="personnel.php">
                  <div class="fb-14 d-flex align-items-center primaryc px-2 py-3 strokem">
                    <img class="mx-2" src="img/icon-user-active.png" width="16px" height="16px" alt="">
                    پرسنل
                  </div>
                </a>
              <?php endif; ?>
        ...
        <div class="col animation-pop p-lg-5 p-3 pt-5 mt-5 mt-lg-0 pt-lg-5">
          <div class="row p-lg-0 p-3">
            <div class="col d-flex justify-content-end p-0 mb-3">
              <p class="display-1 col align-content-center">پرسنل</p>
              <button id="button-form" class="btn-type">بستن و نمایش فرم</button>
            </div>
            <form method="POST" class=" animation-fade" action="personnel.php<?php if(isset($_GET['id'])){echo '?id='.htmlspecialchars($person['code']);} ?>" id="form" style="<?php if(isset($_GET['id'])){echo "display:block;";}else{echo "display:none;";} ?>">
            <div class="d-flex flex-column mb-3">
                <div class="d-flex flex-lg-row flex-column flex-row ">
                  <div class="ms-lg-3 col">
                    <label for="name">نام و نشان</label>
                    <input value="<?php if(isset($_GET['id'])){echo htmlspecialchars($person['name']);} ?>" name="name" type="text" class="form-control-simple mt-1 ms-lg-3" placeholder="نام و نشان" required>
                  </div>
                  <div class="input-group ms-lg-3 mt-lg-0 mt-3">
                    <label for="medal">درجه</label>
                    <select class="input-group-prepend w-100 form-control fb-14 g60 mt-1 dropdown-toggle" name="medal"  value="<?php if(isset($_GET['id'])){echo htmlspecialchars($person['medal']);} ?>" required>
                      <option class="fb-14" value="1" <?php if(isset($_GET['id'])){if($person['medal']==1){echo "selected";}} ?>>سرباز وظیفه</option>
                      <option class="fb-14" value="2" <?php if(isset($_GET['id'])){if($person['medal']==2){echo "selected";}} ?>>گروهبان سوم</option>
                      <option class="fb-14" value="3" <?php if(isset($_GET['id'])){if($person['medal']==3){echo "selected";}} ?>>گروهبان دوم</option>
                      <option class="fb-14" value="4" <?php if(isset($_GET['id'])){if($person['medal']==4){echo "selected";}} ?>>گروهبان یکم</option>
                      <option class="fb-14" value="5" <?php if(isset($_GET['id'])){if($person['medal']==5){echo "selected";}} ?>>استوار دوم</option>
                      <option class="fb-14" value="6" <?php if(isset($_GET['id'])){if($person['medal']==6){echo "selected";}} ?>>استوار یکم</option>
                      <option class="fb-14" value="7" <?php if(isset($_GET['id'])){if($person['medal']==7){echo "selected";}} ?>>ستوان سوم</option>
                      <option class="fb-14" value="8" <?php if(isset($_GET['id'])){if($person['medal']==8){echo "selected";}} ?>>ستوان دوم</option>
                      <option class="fb-14" value="9" <?php if(isset($_GET['id'])){if($person['medal']==9){echo "selected";}} ?>>ستوان یکم</option>
                      <option class="fb-14" value="10" <?php if(isset($_GET['id'])){if($person['medal']==10){echo "selected";}} ?>>سروان</option>
                      <option class="fb-14" value="11" <?php if(isset($_GET['id'])){if($person['medal']==11){echo "selected";}} ?>>سرگرد</option>
                      <option class="fb-14" value="12" <?php if(isset($_GET['id'])){if($person['medal']==12){echo "selected";}} ?>>سرهنگ دوم</option>
                      <option class="fb-14" value="13" <?php if(isset($_GET['id'])){if($person['medal']==13){echo "selected";}} ?>>سرهنگ تمام</option>
                      <option class="fb-14" value="14" <?php if(isset($_GET['id'])){if($person['medal']==14){echo "selected";}} ?>>سرتیپ</option>
                      <option class="fb-14" value="15" <?php if(isset($_GET['id'])){if($person['medal']==15){echo "selected";}} ?>>سرلشکر</option>
                    </select>
                  </div>
                  <div class="ms-lg-3 col mt-lg-0 mt-3">
                    <label for="code">کد ملی</label>
                    <input name="code" value="<?php if(isset($_GET['id'])){echo htmlspecialchars($person['code']);} ?>" type="text" class="form-control-simple mt-1 ms-lg-3" pattern="{0,9}" placeholder="کد ملی" required>
                  </div>
                  <div class="ms-lg-3 col mt-lg-0 mt-3">
                    <label for="personnel_code">کد پرسنلی</label>
                    <input name="personnel_code" value="<?php if(isset($_GET['id'])){echo htmlspecialchars($person['personnel_code']);} ?>" type="text" class="form-control-simple mt-1 ms-lg-3" placeholder="شماره پرسنلی" required>
                  </div>
                  <div class="ms-lg-0 col mt-lg-0 mt-3">
                    <label for="phone">تلفن</label>
                    <input value="<?php if(isset($_GET['id'])){echo htmlspecialchars($person['phone']);} ?>" name="phone" type="text" class="form-control-simple mt-1 ms-lg-3" placeholder="تلفن" required>
                  </div>
                </div>
                <div class="d-flex flex-lg-row flex-column flex-row mt-3 justify-end">
                  <div class="ms-lg-3 col">
                    <label for="name">آدرس</label>
                    <input value="<?php if(isset($_GET['id'])){echo htmlspecialchars($person['city']);} ?>" name="city" type="text" class="form-control-simple mt-1 ms-lg-3" placeholder="آدرس" required>
                  </div>
                  <div class="ms-lg-3 col mt-lg-0 mt-3">
                  <label for="birth">تاریخ تولد</label>
                    <div class="col input-group ms-3">
                        <div class="input-group-prepend ">
                          <div class="input-group-text h-100" id="basic-addon1">
                        ...
                        <input name="birth" value="<?php if(isset($_GET['id'])){echo htmlspecialchars($person['birth']);} ?>" type="text" id="start-date" class="form-control jalali-date" placeholder="تاریخ تولد" required>
                      </div>
                    </div>
                  <div class="ms-lg-3 col mt-lg-0 mt-3">
                  <label for="dispatch">تاریخ اعزام</label>
                    <div class="col input-group ms-3">
                      <div class="input-group-prepend">
                      ...
                      <input name="dispatch" value="<?php if(isset($_GET['id'])){echo htmlspecialchars($person['dispatch']);} ?>" type="text" id="end-date" class="form-control jalali-date" placeholder="تاریخ اعزام" required>
                    </div>
                  </div>
                  <div class="input-group mt-lg-0 mt-3 col ms-lg-3">
                    <label for="type">نوع</label>
                    <select class="input-group-prepend w-100 form-control fb-14 g60 dropdown-toggle" name="type"  value="<?php if(isset($_GET['id'])){echo htmlspecialchars($person['type']);} ?>" required>
                      <option class="fb-14" value="soldier" <?php if(isset($_GET['id'])){if($person['type']=='soldier'){echo "selected";}} ?>>وظیفه</option>
                      <option class="fb-14" value="cadre" <?php if(isset($_GET['id'])){if($person['type']=='cadre'){echo "selected";}} ?>>پایور</option>
                    </select>
                  </div>
                  <div class="input-group col mt-lg-0 mt-3">
                    <label for="status">وضعیت</label>
                    <select class="input-group-prepend w-100 form-control fb-14 g60 dropdown-toggle" name="status"  value="<?php if(isset($_GET['id'])){echo htmlspecialchars($person['status']);} ?>" required>
                      <option class="fb-14" value="active" <?php if(isset($_GET['id'])){if($person['status']=='active'){echo "selected";}} ?>>در حال انجام وظیفه</option>
                      <option class="fb-14" value="leave" <?php if(isset($_GET['id'])){if($person['status']=='leave'){echo "selected";}} ?>>ترخیص شده</option>
                    </select>
                  </div>
            ...
            <div class="row d-flex p-0 m-0 justify-content-between">
              ...
              <div class="col-lg-2 col-4 p-0 ps-0 align-content-center">
            ...
            <div class="col p-0 flex-column d-lg-none" id="responsive-table">
              ...
              <div class="col flex-column base mt-3 responsive-row" data-status='<?php echo $row["type"]; ?>'>
                    ...
                    <div class="action-menu">
                      ...
                      <path d="M3.3335 10C2.80306 10 2.29436 9.78929 1.91928 9.41421C1.54421 9.03914 1.3335 8.53043 1.3335 8C1.3335 7.46957 1.54421 6.96086 1.91928 6.58579C2.29436 6.21071 2.80306 6 3.3335 6C3.86393 6 4.37264 6.21071 4.74771 6.58579C5.12278 6.96086 5.3335 7.46957 5.3335 8C5.3335 8.53043 5.12278 9.03914 4.74771 9.41421C4.37264 9.78929 3.86393 10 3.3335 10ZM12.6668 10C12.1364 10 11.6277 9.78929 11.2526 9.41421C10.8775 9.03914 10.6668 8.53043 10.6668 8C10.6668 7.46957 10.8775 6.96086 11.2526 6.58579C11.6277 6.21071 12.1364 6 12.6668 6C13.1973 6 13.706 6.21071 14.081 6.58579C14.4561 6.96086 14.6668 7.46957 14.6668 8C14.6668 8.53043 14.4561 9.03914 14.081 9.41421C13.706 9.78929 13.1973 10 12.6668 10ZM8.00016 10C7.46973 10 6.96102 9.78929 6.58595 9.41421C6.21088 9.03914 6.00016 8.53043 6.00016 8C6.00016 7.46957 6.21088 6.96086 6.58595 6.58579C6.96102 6.21071 7.46973 6 8.00016 6C8.5306 6 9.0393 6.21071 9.41438 6.58579C9.78945 6.96086 10.0002 7.46957 10.0002 8C10.0002 8.53043 9.78945 9.03914 9.41438 9.41421C9.0393 9.78929 8.5306 10 8.00016 10Z" fill="#697077"/>
                        ...
                        <ul class="menu-options">
                            <li><a class="fb-14 dropdown-section" href="personnel.php?id=<?php echo $row['code']; ?>">ویرایش</a></li>
                            <li><a class="fb-14 dropdown-del" href="personnel.php?delete_id=<?php echo $row['code']; ?>"  onclick="return confirm('آیا از حذف این مورد مطمئن هستید?');">حذف</a></li>
                        </ul>
                    </div>
                  </span>
                </div>
                ...
                <div class="px-3 py-2 d-flex flex-row justify-content-between bottom-line">
                  <span class="flex-start fb-16 g60">کد ملی</span>
                  <span class="flex-end fb-16 g100"><?php echo htmlspecialchars($row['code']); ?></span>
                </div>
                <div class="px-3 py-2 d-flex flex-row justify-content-between bottom-line">
                  <span class="flex-start fb-16 g60">شماره پرسنلی</span>
                  <span class="flex-end fb-16 g100"><?php echo htmlspecialchars($row['personnel_code']); ?></span>
                </div>
                <div class="px-3 py-2 d-flex flex-row justify-content-between bottom-line">
                  <span class="flex-start fb-16 g60">آدرس</span>
                  <span class="flex-end fb-16 g100"><?php echo htmlspecialchars($row['city']); ?></span>
                </div>
                <div class="px-3 py-2 d-flex flex-row justify-content-between bottom-line">
                  <span class="flex-start fb-16 g60">تاریخ تولد</span>
                  <span class="flex-end fb-16 g100"><?php echo htmlspecialchars($row['birth']); ?></span>
                </div>
                <div class="px-3 py-2 d-flex flex-row justify-content-between bottom-line">
                  <span class="flex-start fb-16 g60">تاریخ اعزام</span>
                ...
                <div class="px-3 py-2 d-flex flex-row justify-content-between bottom-line">
                  <span class="flex-start fb-16 g60">وضعیت</span>
                  <span class="flex-end fb-16 <?php if($row['status']==='active'){echo 'sbadge' ;}elseif($row['status']==='leave'){echo 'abadge' ;} ?> fb-14"><?php echo translateStatus(htmlspecialchars($row['status'])); ?></span>
                </div>
              </div>
            <?php endforeach; ?>
              <?php else: ?>
              ...
              <tbody>
                <?php if (count($personnel) > 0): ?>
                  ...
                  <td class="flex-column">
                    ...
                    <p class="fb-14 g60" style="line-height:8px;"><?php echo translateType(htmlspecialchars($row['type'])); ?></p>
                  </td>
                  <td class="">
                  ...
                  <td class=""><?php echo htmlspecialchars($row['personnel_code']); ?></td>
                  <td class=""><?php echo htmlspecialchars($row['city']); ?></td>
                  <td class=""><?php echo htmlspecialchars($row['birth']); ?></td>
                  <td class=""><?php echo htmlspecialchars($row['dispatch']); ?></td>
                  <td class=""><?php echo htmlspecialchars($row['phone']); ?></td>
                  <td class="">
                   <span class="<?php if($row['status']==='active'){echo 'sbadge' ;}elseif($row['status']==='leave'){echo 'abadge' ;} ?> fb-14"><?php echo translateStatus(htmlspecialchars($row['status'])); ?></span>
                  </td>
